    ...
    <div>
      ...
      <div>
        ...
        <section id="internships">
          ...
          <p>Explore hands-on internships for real-world experience</p>
          <div className="internship-box">
            <div className="internship">
              <h3>Web Development Intern</h3>
              <p>Location: Remote</p>
              <p>Duration: 3 months</p>
              <p>Apply now and start building your career in web development!</p>
              <div className="btn">
                <Link className="yellow" to="/internship/web-development">
                  Learn More
                </Link>
              </div>
            </div>
            <div className="internship">
              ...
              <p>Location: Remote</p>
              <p>Duration: 3 months</p>
              <p>Gain hands-on experience in data analysis and AI technologies.</p>
              <div className="btn">
                <Link className="yellow" to="/internship/data-science">
                  Learn More
                </Link>
              </div>
            </div>
            <div className="internship">
              ...
              <p>Location: Remote</p>
              <p>Duration: 3 months</p>
              <p>Enhance your design skills by working on real-world projects.</p>
              <div className="btn">
                <Link className="yellow" to="/internship/ui-ux">
                  Learn More
                </Link>
              </div>
            </div>
